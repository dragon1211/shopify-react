...
const TopTitle: FC<TopTitleProps> = ({title, subtitle, boxProps}) => {
  return (
      <Box display={{base:"block", md:"flex"}} alignItems={{base:"none", md:"flex-end"}} {...boxProps}>
          <Text variant="primary" fontFamily={'Nort'} fontSize={{base: '40px', md: '50px'}} whiteSpace="nowrap">
              {title}
          </Text>
          <Text fontSize={{base: '15px', md: '16px'}} pb="15px" mt={{ base:'8px', md:'0px' }} ml={{base:"0px", md: "40px"}} letterSpacing=".1em">
              {subtitle}
          </Text>
      </Box>
  )
...
const ConceptSection1 = () => {
  ...
  const header_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con1_header.png";

  const middle_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con1_middle.png";
  ...
  return (
    <>
      <TopTitle title="CONCEPT" subtitle="ブランドに込めた想い" boxProps={{ pt:'140px', mb:{base:"80px", md: "50px"} }}/>
      <Image maxW={{ base:'241px', md:'369px' }}
          w="100%"
          src={title}
          fallbackSrc={title}
          alt="休養と栄養を届ける"
      />
      <Flex mt={{ base:'', md:'15px' }}
          direction={{ base:'column-reverse', md:'row' }} 
          justifyContent={{ base:'', md:'center' }}
          alignItems={'center'}
      >
          <Box mt={{ base:'80px', md:'30px' }}
              pr={{ base: '0', md:"40px"}} 
              w ={{ base:'', md: '50%' }}
              position={'relative'}
          >
              <Box>
                  <TopTitleDesc 
                      desc={
                        <>
                            ママの休食の「休食」という言葉には、<br/>
                            「休む（適度な栄養をとる）こと」と <br/>
                            「給食のような栄養バランスのとれた食事をとること」の 
                            ２つの意味がこめられています。 <br/><br/>

                            新しい生命を育み・産み出す性である<br/>
                            女性（ママ）には、<br/>
                            栄養バランスのとれた食事と<br/>
                            適度な休養が必要です。
                        </>
                  ...
                  <TopTitleDesc 
                      desc={
                        <>
                          休養と栄養をたっぷりとった元気なママは、<br/>
                          家族の健康のみなもとであり、<br/>
                          私たちは、そんなママやご家族に寄り添う<br/>
                          サービスでありたいと考えています。
                        </>
                      }
                      descMobile={
...
const ConceptSection2 = () => {
  ...
  const header_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con2_header.png";

  const middle_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con2_middle.png";
  ...
  return (
    <>
      <Image maxW={{ base:'239px', md:'375px' }}
          w="100%"
          src={title}
          fallbackSrc={title}
...
const ConceptSection3 = () => {
  ...
  const header_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con3_header.png";

  const middle_img = "https://mamkayu-assets.s3.ap-northeast-1.amazonaws.com/about_con3_middle.png";
  ...
  return (
    <>
      <Image maxW={{ base:'136px', md:'206px' }}
        w="100%"
        src={title}
        fallbackSrc={title}
        alt="ロゴマークにこめた想い"
          ...
          <TopTitleDesc 
            ...
            desc={
              <>
                  ...
                  マークは漢字の「休」の文字をかたどり、<br/>
                  ママの休食が、ママそしてご家族に<br/>
                  休養と栄養を届けるサービスであることを<br/>
                  表しています。<br/><br/>

                  私たちは、国旗にも見えるこのマークを、<br/>
                  子育てカルチャーの次世代スタンダードを示す<br/>
                  旗印にしていきます。
              </>
            }
            descMobile={
...
const ConceptSection4 = () => {
  ...
  return (
    <>
      <Image maxW={{ base:'264px', md:'462px' }}
          w="100%"
          src={title}
          fallbackSrc={title}
          alt="ママの休食はママを通じてご家族の健康を支えたい"
      />
      <Text variant={'topDescription'}
          mt={{ base:'77px', md:'75px' }}
      >
          ママの休食では、若年女性の低体重や妊産婦の低栄養、
          低出生体重児の割合の高さなどの日本の健康問題・社会課題に目を向け、
          「ママに休養と栄養を届ける」ことをテーマに、サービスを展開してまいりました。  <br/><br/>

          しかし、多くの方にママの休食をご利用いただく中で、
          プレママや育児ママという女性のライフステージだけでなく、
          「ご家族」というライフステージにも休養と栄養の大きな課題があると気づきました。  <br/><br/>
  ...
  return(
    ...
    >
        <Box
           ...
           top={{ base:'0', md:'-110px' }}
        >
            <Image maxW={{ base:'237px', md:'361px' }}
                w="100%"
                src={title}
                fallbackSrc={title}
                alt="実は身近な女性の低栄養問題"
              ...
              <TopTitleDesc  
                  ...
                  desc={
                    <>
                      ...
                      その原因の一つとして若い世代の女性や妊婦の低栄養の問題が指摘されています。<br/>
                      これは日本の重要な社会課題です。
                    </>
                  }
                  descMobile={
  ...
  return(
    ...
    >
        <Box
           ...
           top={{ base:'0', md:'-110px' }}
        >
            <Image maxW={{ base:'242px', md:'609px' }}
                w="100%"
                src={title}
                fallbackSrc={title}
                alt="自由でゆとりのある時間を増やし
        ...
        >
            ...
            >
              ...
              <TopTitleDesc  
                  ...
                  desc={
                    <>
                      家事、とくに炊事を担うということは、家族の健康を担うということ。 <br/>
                      だからこそ、その担い手となるパパ・ママには、手作り家庭料理に固執することなく、 <br/>
                      外食や中食・外注などを含む幅広い選択肢の中で、自分自身にとっても家族にとっても、 <br/>
                      よりヘルシーな（健康的な）選択をしてほしいと願っています。<br/><br/>

                      ママの休食は“手間抜きの手段”ではなく、“賢い選択肢の一つ”となって、 <br/>
                      ママそしてご家族に寄り添い続けます。
                    </>
                  }
                  descMobile={
  ...
  return(
    ...
    >
        <Box
           ...
           top={{ base:'0', md:'-110px' }}
        >
            <Image maxW={{ base:'262px', md:'400px' }}
                w="100%"
                src={title}
                fallbackSrc={title}
                alt="プロダクトは
        ...
        >
            ...
            >
              ...
              <TopTitleDesc  
                  ...
                  desc={
                    <>
                      お客様とともに事業をつくる「共創」はママの休食のテーマのひとつです。<br/>
                      ママの休食を利用してくださるご家族とともに <br/>
                      より良いプロダクトを作っていきたいと思います。<br/>
                    </>
                  }
                  descMobile={
                    <>
  ...
  <Box>
    ...
    <Flex justify={'center'} mt={{ base:'140px', md:'90px' }}>
        <Box w="1200px" position={'relative'}>
            ...
            >
                <Image maxW={{ base:'137px', md:'178px' }}
                    w="100%"
                    src={top}
                    fallbackSrc={top}
                    alt="ママの休食はママを通じてご家族の健康を支えたい"
...
const CText: FC<CTextProps> = ({text, textMobile, textProps}) => {
  return (
      <>
          <Text variant="topDescription" display={{base: "none", md: "block"}} {...textProps}>
            {text}
          </Text>
          <Text variant="topDescription" display={{base: "block", md: "none"}} {...textProps}>
            {textMobile}
          </Text>
      </>
  )
    ...
    <VStack alignItems="center" spacing='0'>
      <Zoom duration={500}>
        <CText
          ...
          text={
            <>
              リアルユーザーから見た「ママの休食」って？
            </>
          }
          textMobile={
            <>
              リアルユーザーから見た<br/>ママの休食」って？
            </>
          }
        />
        <CText
      ...
      <Zoom duration={1000}>
        <Flex justify="center" mt={{base:'67px', md:'75px'}}>
          <PrimaryButton title="お客様の声" href="#" buttonProps={{minW:'250px'}}/>
        </Flex>
      </Zoom>
      <Zoom duration={1500}>
        ...
        <Flex 
          ...
          flexWrap="wrap">
            <Flex alignItems="center">
              <Box as='a' href={sns[0].url} mr={{ base:'33px', md:'45px' }}>{sns[0].icon}</Box>
              <Box as='a' href={sns[1].url} mr={{ base:'33px', md:'45px' }}>{sns[1].icon}</Box>
              <Box as='a' href={sns[2].url}>{sns[2].icon}</Box>
            </Flex>
            <Flex alignItems="center" mt={{ base:'33px', md:'0' }}>
              <Box as='a' href={sns[4].url} mr={{ base:'33px', md:'45px' }}>{sns[4].icon}</Box>
              <Box as='a' href={sns[3].url}>{sns[3].icon}</Box>
            </Flex>
        </Flex>
      </Zoom>
      <Fade bottom>
